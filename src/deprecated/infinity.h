...
public:
     ...
     */
    static Result check(const VarMan &varMan, GuardList guard, Expression cost, bool isFinalCheck);

private:
    InfiniteInstances(const VarMan &varMan, GuardList guard, Expression cost);
