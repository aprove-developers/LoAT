...
bool PruningNL::removeDuplicateRules(ITSProblem &its, const vector<TransIdx> &trans, bool compareUpdate) {
...
bool PruningNL::removeUnsatInitialRules(ITSProblem &its) {
    bool changed = false;
...
/*
bool PruningNL::pruneParallelRules(LinearITSProblem &its) {
...
bool PruningNL::removeLeafsAndUnreachable(ITSProblem &its) {
