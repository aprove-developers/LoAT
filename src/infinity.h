...
public:
     ...
     */
    static Result check(const ITRSProblem &its, GuardList guard, Expression cost, bool isFinalCheck);

private:
    InfiniteInstances(const ITRSProblem &its, GuardList guard, Expression cost);
