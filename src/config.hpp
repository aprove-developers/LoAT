...
namespace Config {
    ...
    namespace Analysis {
        ...
        enum Mode { Complexity, NonTermination, Acceleration, RankingFunction, RecurrentSet, RecurrentSetNoInc, RecurrentSetNoFP, RecurrentSetNoEvInc, RecurrentSetTrivial, Smt2Export, CIntExport };
