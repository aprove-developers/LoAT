...
namespace strengthening {
    ...
    const Types::MaxSmtConstraints
    Self::pseudoInvariance(const Types::SmtConstraints &constraints, Z3Context &context) {
        Types::MaxSmtConstraints res;
    ...
    const Types::MaxSmtConstraints
    Self::pseudoMonotonicity(const Types::SmtConstraints &constraints, Z3Context &context) {
        Types::MaxSmtConstraints res;
        res.hard.insert(res.hard.begin(), constraints.initiation.satisfiable.begin(),
