...
namespace strengthening {
    ...
    const Types::SmtConstraints Self::buildSMTConstraints() const {
        ...
        invariancePremise.insert(invariancePremise.begin(), templatesInvariantImplication.premise.begin(),
        ...
        const std::vector<z3::expr> &conclusionInvariant = constructZ3Implication(invariancePremise,
                                                                                  invarianceConclusion);
        const std::vector<z3::expr> &conclusionMonotonic = constructZ3Implication(monotonicityPremise,
