...
RecurrenceNL::RecurrenceNL(const VarMan &varMan)
...
vector<VariableIdx> RecurrenceNL::dependencyOrder(UpdateMap &update) {
...
//NOTE: variables in update must already be replaced by their recurrence (containing Purrs::RecurrenceNL::n)
bool RecurrenceNL::findUpdateRecurrence(Expression update, ExprSymbol target, Expression &result) {
...
bool RecurrenceNL::findCostRecurrence(Expression cost, Expression &result) {
    Timing::Scope timer(Timing::Purrs);
...
bool RecurrenceNL::calcIteratedUpdate(const UpdateMap &oldUpdate, const Expression &meterfunc, UpdateMap &newUpdate) {
...
bool RecurrenceNL::calcIteratedCost(const Expression &cost, const Expression &meterfunc, Expression &newCost) {
...
bool RecurrenceNL::calcIteratedCost(const VarMan &varMan, LinearRule &rule, const Expression &meterfunc) {
    unimplemented();

    RecurrenceNL rec(varMan);
