...
#ifndef NL_RECURRENCE_H
#define NL_RECURRENCE_H
...
public:
    /**
     * Tries to solve recurrences for the iterated cost only.
     ...
     */
    static bool calcIteratedCost(const VarMan &varMan, LinearRule &rule, const Expression &meterfunc);

private:
    RecurrenceNL(const VarMan &varMan);
