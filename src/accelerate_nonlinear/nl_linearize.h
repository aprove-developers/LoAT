...
#ifndef NL_LINEARIZE_H
#define NL_LINEARIZE_H
...
private:
    LinearizeNL(GuardList &guard, std::vector<UpdateMap> &updates, VarMan &varMan) : guard(guard), updates(updates), varMan(varMan) {}
