...
namespace Chaining {
     ...
     */
    option<Rule> chainRules(const VarMan &varMan, const Rule &first, const Rule &second);
     ...
     */
    option<LinearRule> chainRules(const VarMan &varMan, const LinearRule &first, const LinearRule &second);
};
